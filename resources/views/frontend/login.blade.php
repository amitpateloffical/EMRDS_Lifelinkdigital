...
<head>
    ...
    <style>
        * {
        ...
        #rcms_login_block .login-form-block .top-block .logo-container {
            display: flex;
            justify-content: center;
            align-items: center;
            margin-bottom: 30px;
        ...
        #rcms_login_block input[type="submit"] {
            ...
            box-shadow: -1px 4px 7px #c5c5c5, 2px -1px 8px #ffffff;
        }
...
<body>
    ...
    {{-- ======================================
                    LOGIN FORM
    ======================================= --}}
    <div id="rcms_login_block" style="background-image: url('{{ asset('assets/image/main-screen.jpg') }}')">

        <div class="img-container">
            <img src="{{ asset('assets/image/loginview.png') }}" alt="">
        </div>

        <div id="login-button">
            <button type="button" id="HR-btn" class="role-btn" data-role="HR"><i class="fa-solid fa-user-tie fa-xl"
                    style="color: #ffffff; padding-right: 63px; margin-left: -53px;"></i>HR</button>
            <button type="button" id="MedOffice-btn" class="role-btn" data-role="Medical Officer"> <i
                    class="fa-solid fa-hospital-user fa-xl" style="color: #ffffff; padding-right: 20px;"></i>Medical
                Officer</button>
            <button type="button" id="NurStaff-btn" class="role-btn" data-role="Nurshing Staff"><i
                    class="fa-solid fa-user-nurse fa-xl"
                    style="color: #ffffff; padding-right: 30px; margin-left: -11px;"></i>Nursing
                Staff</button>
            <button type="button" id="Ohc-btn" class="role-btn" data-role="OHC Head"><i
                    class="fa-solid fa-user-gear fa-xl"
                    style="color: #ffffff; padding-right: 25px; margin-left: -29px;"></i>OHC Head</button>
        </div>
