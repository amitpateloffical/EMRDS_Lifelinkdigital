    ...
    <div id="rcms_form-head">
        <div class="container-fluid">
            <div class="inner-block">
                <div class="head"></div>
                <div class="slogan">
                    <strong>Division: Pune, Maharashtra / Project: Medical check-up of visitors / auditors</strong>
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <div class="cctab">
                ...
                <button class="cctablinks" onclick="openCity(event, 'CCForm3')">Medical Checkup</button>
                <button class="cctablinks" onclick="openCity(event, 'CCForm4')">Medical Officer Entry</button>
                <button class="cctablinks" onclick="openCity(event, 'CCForm5')">Acknowledgment</button>
                <button class="cctablinks" onclick="openCity(event, 'CCForm6')">Activity Logs</button>
            </div>
                    ...
                    <div id="CCForm1" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="nature-change">Requested Date</label>
                                        <input type="text" name="date">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="others">Visitor/Auditor Name</label>
                                        <input type="text" name="contact">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="support-doc">Department to be Visited</label>
                                        <input type="text" name="id">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="support-doc">Organization/Agency of Visitor/Auditors</label>
                                        <select id="select-state" placeholder="Select..." name="assign_to">
                                ...
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="support-doc">Intention to Enter Clean Room</label>
                                        <select id="select-state" placeholder="Select..." name="assign_to">
                                            <option value="">-- Select --</option>
                                ...
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="support-doc">Visitor/Auditor ID</label>
                                        <input type="text" name="id">
                                    </div>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="support-doc">Attachment</label>
                                        <textarea name="short_description" id="short_description"></textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="CCForm3" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="qa_head">Medical Checkup Date and Time</label>
                                        <input type="datetime" name="qa_head">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="qa_head">Medical Checkup Details</label>
                                        <input type="text" name="qa_head">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="qa_comments">Checkup Number</label>
                                        <input type="text">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="qa_comments">Next Checkup Date</label>
                                        <input type="date" id="txtDate">
                                    </div>
                                </div>
                                <div class="col-12">
                    ...
                    <div id="CCForm4" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="support-doc">Fitness Status</label>
                                        <select id="select-state" placeholder="Select..." name="assign_to">
                                            <option value="">-- Select --</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Production">Effective Date</label>
                                        <input type="date" id="txtDate">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="group_review">Medical Certificate</label>
                                        <input type="text">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Microbiology">Officer Comment</label>
                                        <textarea name="other_comment"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="group_review">Additional Medical Attachment</label>
                                        <input type="text">
                                    </div>
                                </div>
                                <div class="button-block">
                    ...
                    <div id="CCForm5" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="support-doc">Task Closure Status</label>
                                        <select id="select-state" placeholder="Select..." name="assign_to">
                                            <option value="">-- Select --</option>
                                            <option value="">Fit </option>
                                            <option value="">Unfit</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Production-Person">Summary</label>
                                        <textarea name="other_comment"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Production-Person">Acknowledgment Comments</label>
                                        <textarea name="other_comment"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        <label for="Quality-Approver">Acknowledgment Attachment</label>
                                        <input type="file">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="CCForm6" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Submit 0n</label>
                                        <div class="static">12/02/2023</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Entry By</label>
                                        <div class="static">Ajay kumar</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Entry On</label>
                                        <div class="static">12/02/2023</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Perform By</label>
                                        <div class="static">Ajay kumar</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Perform On</label>
                                        <div class="static">12/02/2023</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
