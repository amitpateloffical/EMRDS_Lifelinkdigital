...
<body>
    ...
    <header>
        <table>
            <tr>
                ...
                <td class="w-30">
                    <div class="logo">
                        <img src="https://dms.connexodemo.com/user/images/logo1.png" alt="" class="w-100">
                    </div>
                </td>
            </tr>
        </table>
        <table>
            <tr>
                ...
                <td class="w-40">
                    PEMC/2023/  {{ str_pad($doc->id, 4, '0', STR_PAD_LEFT) }}
                </td>
    ...
    <div class="inner-block">
        ...
        <div class="division">
            Pune, Maharashtra/ Pre Employment Medical Checkup
        </div>
        ...
        <div class="first-table">
            <table>
                <tr>
                    ...
                    <td class="w-50">
                        <strong>Start Date (GMT) :</strong> {{ $doc->create }}
                    </td>
                </tr>
                <tr>
                    <td class="w-50">
