    ...
    <div id="rcms_form-head">
        <div class="container-fluid">
            <div class="inner-block">
                <div class="head"></div>
                <div class="slogan">
                    <strong>Division: Pune, Maharashtra / Project: First Aid & First Aid boxes</strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <div class="cctab">
                ...
                <button class="cctablinks" onclick="openCity(event, 'CCForm2')">Acknowledgement Request</button>
                <button class="cctablinks" onclick="openCity(event, 'CCForm3')">Nursing Staff Maintainance</button>
                <button class="cctablinks" onclick="openCity(event, 'CCForm4')">Officer Oversight</button>
                    ...
                    <div id="CCForm1" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="doc-detail">
                                            Address Details<button type="button" name="ann"
                                ...
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="short-desc">Employee ID<span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="risk_level">Reason for Employee Change</label>
                                        <input type="text" name="reason_for_employee_change">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <input type="datetime-local" id="birthdaytime" name="training_attendance">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <input type="date" id="txtDate" name="certification" id="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="acknowledgement_comments"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <input type="fiile" name="certification_attachment">
                                    </div>
                                </div>
                                <div class="button-block">
                                    <button type="submit" class="saveButton">Save</button>
                    ...
                    <div id="CCForm3" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="type_change">Maintanance Record</label>
                                        <input type="text" name="maintanance_record">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="qa_head">Refill Supplies</label>
                                        <input type="text" name="refill_supplies">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="qa_comments">Maintanance Comments</label>
                                        <textarea name="maintanance_comments"></textarea>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="group-input">
                                        <label for="related_records">Maintainance Attachment</label>
                                        <input type="file" name="maintainance_attachment">
                                    </div>
                                </div>
                            </div>
                            <div class="button-block">
                    ...
                    <div id="CCForm4" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="group_review">Return Record</label>
                                        <input type="text" name="return_record">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Production">Pending Task Closure/Comments</label>
                                        <textarea name="pending_comment"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Production-Person">Medical Comment</label>
                                        <textarea name="medical_comment"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        <label for="Quality-Approver">Medical Attachment</label>
                                        <input type="file" name="medical_attachment">
                                    </div>
                                </div>
                                <div class="button-block">
                                    <button type="submit" class="saveButton">Save</button>
                    ...
                    <div id="CCForm5" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Authentication and Request By</label>
                                        <div class="static">Amit Guru </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Authentication and Request On</label>
                                        <div class="static">12-12-2032</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Acknowledgment and Orientation Complete By</label>
                                        <div class="static">Amit Guru</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Acknowledgment and Orientation Complete On</label>
                                        <div class="static">12-12-2032</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Record Maintainance By</label>
                                        <div class="static">Piyush Sahu</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Record Maintainance On</label>
                                        <div class="static">12-12-2032</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Refill Supplier By</label>
                                        <div class="static">Ajay kumar</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Refill Supplier On</label>
                                        <div class="static">12/02/2023</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Handle Returns By</label>
                                        <div class="static">Ajay kumar</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="submitted">Handle Returns On</label>
                                        <div class="static">12/02/2023</div>
                                    </div>
                                </div>
                            </div>
