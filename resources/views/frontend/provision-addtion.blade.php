    ...
    <div id="rcms_form-head">
        <div class="container-fluid">
            <div class="inner-block">
                <div class="head"></div>
                <div class="slogan">
                    <strong>Division: Pune, Maharashtra / Project: Provision for addition of any new workflow</strong>
                    ...
                    <div id="CCForm3" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="type_change">Nursing Staff Data Entry</label>
                    ...
                    <div id="CCForm4" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Production">Medical Officer'Observations</label>
                                        <input type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6">
